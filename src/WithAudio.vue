  ...
  <div class="container mx-auto text-center">
    <div class="home-container" v-if="streamStatus === 'NONE'">
      <button @click="startStream()">
        <span>Select a screen and audio</span>
      </button>
    </div>
...
async function startStream() {
  ...
  navigator.mediaDevices
    ...
    .then(() => startRecordingWithAudio(preview.captureStream()))
    .then((recordedChunks) => {
...
async function startRecordingWithAudio(stream: MediaStream | null) {
  if (!stream) return;
  ...
  let recorder = new MultiStreamRecorder(
    [stream, audioStream],
    {}
  ) as MultiStreamRecorder;
